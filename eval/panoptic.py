...
class PQStat:
    ...
    def pq_average(self, categories: List[int]):
        ...
        # ToDo: Why is n zero at all? This case should actually never happen... Needs to be
        #  checked as it deviates from the implementation in cityscapesscripts now with the case
        #  handling
        if n == 0:
